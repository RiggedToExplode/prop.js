...
```javascript
//NOTICE: This example is somewhat outdated for this new version of the framework, as the framework has just completed a major revision that changes a few things.
